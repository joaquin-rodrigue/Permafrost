/// <summary>
/// Individual states for the Bigfoot state machine.
/// </summary>
public abstract class BigfootState
{
    // The state machine controller
    protected BigfootStateController controller;
    ...
    public BigfootState(BigfootStateController controller)
    {
